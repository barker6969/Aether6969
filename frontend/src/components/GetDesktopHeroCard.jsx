...
const HeroActions = ({ onWindows, onDismiss }) => (
...
// Note: this stores only a boolean dismissal flag ("1") — not sensitive.
  ...
  return (
    ...
    >
      ...
      <div className="relative px-4 py-4 md:px-5 flex flex-col md:flex-row md:items-center gap-4 md:gap-5">
        <HeroInfo />
        <HeroActions onWindows={openWindows} onDismiss={dismiss} />
      </div>
    </div>
  );
};
