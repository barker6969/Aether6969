        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#09090B] border border-white/10 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <div>
                <label className="font-mono text-[10px] tracking-[0.2em] uppercase text-white/50">
                  Password <span className="text-white/30 normal-case tracking-normal">(min 6)</span>
                </label>
                <div className="mt-1.5 flex items-center bg-black border border-white/10 focus-within:border-[#00FF41]/50 transition-colors">
            ...
            <div className="text-center mt-5 font-mono text-[11px] text-white/50">
              ...
              <Link to="/login" data-testid="goto-login-link" className="text-[#00FF41] hover:underline">
                Sign in →
              </Link>
            </div>
          </div>
